...
const u32 kFeatureLeaves[kFeatureLeafCnt][3] = {
    {0x00000001, 0, EDX | ECX},  // cpuid(1, 0) put feature information into edx and ecx
...
#define X86_FEATURE_PCLMULQDQ (0 * 32 + 1)    // carry-less multiplication instruction
...
#define X86_FEATURE_SSSE3 (0 * 32 + 9)        // supplemental streaming simd extensions 3
...
#define X86_FEATURE_TSCDEADLINE (0 * 32 + 24) // APIC support TSC deadline value
...
#define X86_FEATURE_OSXSAVE (0 * 32 + 27)     // CR4.OSXSAVE is set to enable XSAVE features
#define X86_FEATURE_AVX (0 * 32 + 28)         // AVX instruction extensions
#define X86_FEATURE_F16C (0 * 32 + 29)        // floating-point conversion instructions
...
#define X86_FEATURE_FSGSBASE (2 * 32 + 0)        // RDFSBASE, WRFSBASE, RDGSBASE, WRGSBASE instructions
...
#define X86_FEATURE_FDP_EXCPTN_ONLY (2 * 32 + 6) // "" FPU data pointer updated only on x87 exceptions 
...
#define X86_FEATURE_RDT_A (2 * 32 + 15)          // Resource Director Technology Allocation 
#define X86_FEATURE_AVX512F (2 * 32 + 16)        // AVX-512 Foundation 
#define X86_FEATURE_AVX512DQ (2 * 32 + 17)       // AVX-512 DQ (Double/Quad granular) Instructions 
...
#define X86_FEATURE_AVX512IFMA (2 * 32 + 21)     // AVX-512 Integer Fused Multiply-Add instructions 
...
#define X86_FEATURE_AVX512ER (2 * 32 + 27)       // AVX-512 Exponential and Reciprocal 
...
#define X86_FEATURE_AVX512BW (2 * 32 + 30)       // AVX-512 BW (Byte/Word granular) Instructions 
...
#define X86_FEATURE_AVX512VBMI (3 * 32 + 1)        // AVX512 Vector Bit Manipulation instructions
...
#define X86_FEATURE_AVX512_VBMI2 (3 * 32 + 6)      // Additional AVX512 Vector Bit Manipulation Instructions 
#define X86_FEATURE_GFNI (3 * 32 + 8)              // Galois Field New Instructions 
#define X86_FEATURE_VAES (3 * 32 + 9)              // Vector AES 
#define X86_FEATURE_VPCLMULQDQ (3 * 32 + 10)       // Carry-Less Multiplication Double Quadword 
#define X86_FEATURE_AVX512_VNNI (3 * 32 + 11)      // Vector Neural Network Instructions 
#define X86_FEATURE_AVX512_BITALG (3 * 32 + 12)    // Support for VPOPCNT[B,W] and VPSHUF-BITQMB instructions 
#define X86_FEATURE_TME (3 * 32 + 13)              // Intel Total Memory Encryption 
#define X86_FEATURE_AVX512_VPOPCNTDQ (3 * 32 + 14) // POPCNT for vectors of DW/QW 
...
#define X86_FEATURE_AVX512_4VNNIW (4 * 32 + 2)       // AVX-512 Neural Network Instructions 
#define X86_FEATURE_AVX512_4FMAPS (4 * 32 + 3)       // AVX-512 Multiply Accumulation Single precision 
#define X86_FEATURE_FSRM (4 * 32 + 4)                // Fast Short Rep Mov 
#define X86_FEATURE_AVX512_VP2INTERSECT (4 * 32 + 8) // AVX-512 Intersect for D/Q 
...
#define X86_FEATURE_SPEC_CTRL (4 * 32 + 26)          // "" Speculation Control (IBRS + IBPB) 
#define X86_FEATURE_INTEL_STIBP (4 * 32 + 27)        // "" Single Thread Indirect Branch Predictors 
#define X86_FEATURE_FLUSH_L1D (4 * 32 + 28)          // Flush L1D cache 
#define X86_FEATURE_ARCH_CAPABILITIES (4 * 32 + 29)  // IA32_ARCH_CAPABILITIES MSR (Intel) 
#define X86_FEATURE_CORE_CAPABILITIES (4 * 32 + 30)  // "" IA32_CORE_CAPABILITIES MSR 
#define X86_FEATURE_SPEC_CTRL_SSBD (4 * 32 + 31)     // "" Speculative Store Bypass Disable 
